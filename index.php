    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item" style="margin-left: 5%; margin-right: 5%"">
              <a class="nav-link btn btn-primary btn-lg" href="walkin.php">Add Walk-In Order</a>
                </li>
            ...
            <div class="row">
                ...
                <div class="col-sm-7 py-5 pl-md-0 pl-4">
                    ...
                    <div class="pl-lg-5 ml-md-5">
                        <p>Experience culinary excellence at RetroNexus. Indulge in exquisite flavors, impeccable service, and a cozy ambiance. Discover a gastronomic journey that will leave your taste buds delighted and craving more.</p>
    ...
    <div class="inner container">
         <div class="row">
         	...
         	<div class="col-md-12 d-flex align-items-center">
         		<p class="mx-auto text-center mb-0">Copyright 2024. All Right Reserved. </p>
         	</div>
