			...
			<div class = "col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="widget-content">
                  <div class="padd" style="height:650px">
                    ...
                    <h3 style="text-align:center">Gaytri Software</h3>
                    <h4 style="text-align:center">2nd Floor, JTM mall, Jagatpura, Jaipur, Rajasthan 302022</h4>
                    <h4 style="text-align:center">Phone No. : 79766 45581</h4>
                    <h4 style="text-align:center">Gmail : gaytri software</h4>
                    <hr>
